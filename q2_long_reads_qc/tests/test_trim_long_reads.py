...
class TestChopperUtilities(unittest.TestCase):
...
class TestTrim(LongReadsQCTestsBase):
    def setUp(self):
        super().setUp()
...
class TestConstructChopperCommand(unittest.TestCase):
    def test_construct_chopper_command(self):
        # Define the inputs
        quality = 20
        maxqual = 40
...
class TestProcessAndRezip(unittest.TestCase):
