...
class TestRunNanoPlot(LongReadsQCTestsBase):
...
class TestStats(unittest.TestCase):
    @patch("q2_long_reads_qc.nanoplot_stats._create_visualization")
    @patch("q2_long_reads_qc.nanoplot_stats._run_nanoplot")
